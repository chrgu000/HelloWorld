<%@ Page Language="C#" StyleSheetTheme="personal" MasterPageFile="~/Finance/User.master" AutoEventWireup="true" CodeFile="OverTime.aspx.cs" Inherits="Account_OverTime" %>

<asp:Content ID="UserContent" ContentPlaceHolderID="UserContent" Runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server">
    </asp:ScriptManager>
    <div id="overtimeInfo">
        <div class="titlehead"> 加班申请</div>
        <table id="overtimeTable">
            <tr>
                <td>
                    <table class="innerTable">
                        <tr>
                            <td class="bold">姓名</td>
                            <td class="diy"><input name="name" type="text" id="name" class="Text"/></td>
                            <td class="bold">部门</td>
                            <td class="diy">
            ...
            <tr>
                <td>加班时间：<input name="startDate" type="text" id="startDate" runat="server" onClick="WdatePicker()"/>
