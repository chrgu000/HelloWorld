<%@ Page Language="C#" StyleSheetTheme="personal" MasterPageFile="~/Finance/User.master" AutoEventWireup="true" CodeFile="OverTimeShow.aspx.cs" Inherits="Account_OverTimeShow" %>
...
<asp:Content ID="UserContent" ContentPlaceHolderID="UserContent" Runat="Server">
    ...
    <div id="overtimeInfo">
        ...
        <table id="overtimeTable">
            ...
            <tr>
                <td>加班时间：<asp:Literal ID="durings" runat="server"></asp:Literal> </td>
            </tr>
            <tr>
                <td>
                    <table class="innerTable">
