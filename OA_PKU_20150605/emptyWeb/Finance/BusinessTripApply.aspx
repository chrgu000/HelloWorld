<%@ Page Language="C#" StyleSheetTheme="finance" MasterPageFile="~/Finance/User.master" AutoEventWireup="true" CodeFile="BusinessTripApply.aspx.cs" Inherits="Finance_BusinessTripApply" %>
        ...
        <table class="firstTable">
            ...
            <tr>
                ...
                <td colspan="5">
                    ...
                    <br /><asp:RequiredFieldValidator ControlToValidate="reason" ErrorMessage="随行人员、出差地点及事由不能为空" runat="server" style="color:red;font-size:12px" ID="RequiredFieldValidator1"  Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="diy" colspan="3">
                    <asp:TextBox runat="server" name="moneyEstimate" type="text" id="moneyEstimate" class="Text"></asp:TextBox>
                     <asp:RegularExpressionValidator style="color:red;font-size:12px" runat="server" ID="validatorMoney" ControlToValidate="moneyEstimate" ValidationExpression="^[1-9]\d*(\.\d+)?$" ErrorMessage="金额只能是数字" Display="Static" />
                </td>                
