...
<table border='0' width='540' align='center' cellspacing="0" cellpadding="0">
  <tr height='100' bgcolor='#003399'> 
    <td align='cenater' bgcolor="#F9F9FF" height="45" > <div align="center"><font color="#0066FF" size="3"><b><font color="#FF0000">表 格 下 载</font></b></font></div></td>
  </tr>
  <tr> 
	...
	Dim Sql
	Dim Rs
	Sql="select top 100 * from upfortable order by id desc"
  ...
  <tr> 
    <td bgcolor='#F9F9FF'>
      ...
      <table border='0' align="center" cellpadding="5">
        <form method="POST" action="upfilefortable.asp" enctype="multipart/form-data" id="form1" name="form1" onsubmit='return checkSub(this)'>
          <tr>
            <td>报错：</td>
