...
SavePath = "savefortable"									'虚拟路径(后面不要加"/"符号)
...
if len(trim(filename))>0 then
	...
	if not errflag then
		Sql = "insert into upfortable (subject,expit,filepath,filename,filesize) values"
...
Response.Write "window.open('defaultfortable.asp','_self');"
Response.Write "//-->"&vbcrlf
