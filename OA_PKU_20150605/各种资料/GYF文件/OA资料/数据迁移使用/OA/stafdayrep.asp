...
%>
                    ...
                    <select name="myyear" size=1>
                      ...
                      <option value=2010<%=selected(2010,myyear)%>>2010年</option>
                      <option value=2011<%=selected(2011,myyear)%>>2011年</option>
                      <option value=2012<%=selected(2012,myyear)%>>2012年</option>
                      <option value=2013<%=selected(2013,myyear)%>>2013年</option>
                      <option value=2014<%=selected(2014,myyear)%>>2014年</option>
                      <option value=2015<%=selected(2015,myyear)%>>2015年</option>
                      <option value=2016<%=selected(2016,myyear)%>>2016年</option>
                      <option value=2017<%=selected(2017,myyear)%>>2017年</option>
                      <option value=2018<%=selected(2018,myyear)%>>2018年</option>
                      <option value=2019<%=selected(2019,myyear)%>>2019年</option>
                      <option value=2020<%=selected(2020,myyear)%>>2020年</option>
                    </select>
                    ...
                    <input type="submit" name="submit" value="查询"><input type="button"  value="详细情况" onClick="button1();">
                  </td>
                </form>
              </tr>
            </table>
