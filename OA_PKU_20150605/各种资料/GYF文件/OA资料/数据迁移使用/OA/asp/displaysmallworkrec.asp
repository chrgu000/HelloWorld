...
displaysmallworkrec="<a href='displayworkrec.asp?username=" & username & "&superior=" & superior & "&recdate=" & myday & "' onclick='return js_openpage(this.href);'><font color=red>" & Day(myday) & "</font></a>"
end if
