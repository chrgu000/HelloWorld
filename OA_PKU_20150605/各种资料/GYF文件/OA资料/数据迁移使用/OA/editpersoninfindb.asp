...
<tr>
<td>
编辑<!--<%=username%>的-->个人基本档案&nbsp;&nbsp;
</td>
<form method="post" action="changeperinf.asp">
<td>
</td>
</tr>
</table>
...
case "username" username=BinaryToString(Field.value)
case "a2" a(2)=BinaryToString(Field.value)
case "a3" a(3)=BinaryToString(Field.value)
case "a4" a(4)=BinaryToString(Field.value)
case "userdept" userdept=BinaryToString(Field.value)
case "userlevel" userlevel=BinaryToString(Field.value)
...
%>
<br><br>
<center><font color=red >成功输入个人基本档案！</font><br><br><form method="post" action="changeperinf.asp"><input type="button" value="关闭" onClick="window.close();">
</center>
<%
end if
else
...
%>
<br><br>
<center><font color=red >成功修改个人基本档案！</font><br><form method="post" action="changeperinf.asp"><input type="button" value="关闭" onClick="window.close();"></form>
</center>
<%
end if
end if
