...
<form method="post" name="form1" action="getnewemail.asp">
<%
...
sql="select * from userinf,getemailtable where getemailtable.getuserid="&cstr(oabusyuserid)&" and getemailtable.readflag='false' and getemailtable.deleteflag='false' and userinf.id=getemailtable.senduserid  order by emaildate desc"
call listemail(sql,"您现在还没有新邮件!","new")
%>
<br>
<div align="right">
