...
if deptN="所有部门" then 
     if yearN="所有" then
	     ...
	     sql="select * from reimlisttable where (dept="&"'"&oabusyuserdept&"'"&" and type='A' and stage>0) or (type='B' and projectDept = "&"'"&oabusyuserdept&"'"&"  and stage>1 ) order by reimburseDate desc" 
	     end if
		 if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
	     sql="select * from reimlisttable where ((dept="&"'"&oabusyuserdept&"'"&" and type='A' and stage>0) or (dept<>"&"'"&oabusyuserdept&"'"&" and type='A' and stage>2)) or (type='B' and projectDept = "&"'"&oabusyuserdept&"'"&" and stage>0) order by reimburseDate desc"
	     end if
	     ...
	     sql="select * from reimlisttable where (stage >3 and stage < 11) or ( dept="&"'"&oabusyuserdept&"' and stage>0) order by reimburseDate desc"
	     end if
	 ...
	 if yearN<>"所有" then
	   if monthN="" or monthN="所有" then
		...
		t2=DateSerial(yearN+1,1,1)
	     ...
	     if oabusyuserlevelCode="BMJL" and oabusyuserdept<>"综合管理部" then
	     sql="select * from reimlisttable where ((dept="&"'"&oabusyuserdept&"'"&" and type='A' and stage>0 ) or (type='B' and projectDept = "&"'"&oabusyuserdept&"'"&"  and stage>1 )) and reimburseDate between '"&t1&"' and '"&t2&"'  order by reimburseDate desc"
	     end if
		 if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
	     sql="select * from reimlisttable where (((dept="&"'"&oabusyuserdept&"'"&" and type='A' and stage>0) or (dept<>"&"'"&oabusyuserdept&"'"&" and type='A' and stage>2)) or (type='B' and projectDept = "&"'"&oabusyuserdept&"'"&" and stage>0)) and reimburseDate between '"&t1&"' and '"&t2&"'  order by reimburseDate desc" 
	     end if
	     if oabusyuserlevelCode="CWZG" then
		 ...
		 if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
	     sql="select * from reimlisttable where ((stage >3 and stage < 11) or ( dept="&"'"&oabusyuserdept&"' and stage>0)) and reimburseDate between '"&t1&"' and '"&t2&"'   order by reimburseDate desc"
	     end if
	     if oabusyuserlevelCode="CN" then
...
'-------------------------------------------------------	     
		...
		if oabusyuserlevelCode="ZSYG" then
	     ...
	     if oabusyuserlevelCode="BMJL" and oabusyuserdept<>"综合管理部" then
	     sql="select * from reimlisttable where ((dept="&"'"&oabusyuserdept&"'"&" and type='A' and stage>0 ) or (type='B' and projectDept = "&"'"&oabusyuserdept&"'"&"  and stage>1 )) and reimburseDate='"&t1&"'  order by reimburseDate desc" 
	     end if
		 if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
	     sql="select * from reimlisttable where (((dept="&"'"&oabusyuserdept&"'"&" and type='A' and stage>0) or (dept<>"&"'"&oabusyuserdept&"'"&" and type='A' and stage>2)) or (type='B' and projectDept = "&"'"&oabusyuserdept&"'"&" and stage>0))  and reimburseDate='"&t1&"'  order by reimburseDate desc"
	     end if
	     if oabusyuserlevelCode="CWZG" then
		 ...
		 if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
	     sql="select * from reimlisttable where ((stage >3 and stage < 11) or ( dept="&"'"&oabusyuserdept&"' and stage>0)) and reimburseDate='"&t1&"' order by reimburseDate desc"
	     end if
	     if oabusyuserlevelCode="CN" then
...
if deptN<>"所有部门"  and deptN<>"" then 
     if yearN="所有" then
	    ...
	    if oabusyuserlevelCode="ZSYG" then
		 ...
		 if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
	     sql="select * from reimlisttable where (((dept="&"'"&oabusyuserdept&"'"&" and type='A' and stage>0) or (dept<>"&"'"&oabusyuserdept&"'"&" and type='A' and stage>2)) or (type='B' and projectDept = "&"'"&oabusyuserdept&"'"&" and stage>0)) and dept="&"'"&deptN&"'  order by reimburseDate desc" 
	     end if
	     if oabusyuserlevelCode="CWZG" then
	     sql="select * from reimlisttable where ((stage >2 and stage <11) or ( claimant="&"'"&oabusyusername&"'))  and dept="&"'"&deptN&"' order by reimburseDate desc"
	     end if
	     if oabusyuserlevelCode="DSZ" then
	     stage1=3
	     sql="select * from reimlisttable where ((stage >3 and stage <11) or ( claimant="&"'"&oabusyusername&"'))  and dept="&"'"&deptN&"' order by reimburseDate desc"
	     end if
		 if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
	     sql="select * from reimlisttable where ((stage >3 and stage < 11) or ( dept="&"'"&oabusyuserdept&"' and stage>0)) and dept="&"'"&deptN&"' order by reimburseDate desc"
	     end if
	     if oabusyuserlevelCode="CN" then
	     sql="select * from reimlisttable where ((stage>6 and  stage<10) or ( claimant="&"'"&oabusyusername&"'))   and dept="&"'"&deptN&"' order by reimburseDate desc"
	     end if
	     if oabusyuserlevelCode="CW" then
	     sql="select * from reimlisttable where ((stage>4 and  stage<10) or ( claimant="&"'"&oabusyusername&"'))  and dept="&"'"&deptN&"'  order by reimburseDate desc"
	     end if
	 ...
	 if yearN<>"所有" then
	   if monthN="所有" then
		...
		t2=DateSerial(yearN+1,1,1)
		 ...
		 if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
	     sql="select * from reimlisttable where (((dept="&"'"&oabusyuserdept&"'"&" and type='A' and stage>0) or (dept<>"&"'"&oabusyuserdept&"'"&" and type='A' and stage>2)) or (type='B' and projectDept = "&"'"&oabusyuserdept&"'"&" and stage>0)) and reimburseDate between '"&t1&"' and '"&t2&"' and dept="&"'"&deptN&"'  order by reimburseDate desc" 
	     end if
	     if oabusyuserlevelCode="CWZG" then
	     sql="select * from reimlisttable where ((stage >2 and stage <11) or ( claimant="&"'"&oabusyusername&"')) and reimburseDate between '"&t1&"' and '"&t2&"' and dept="&"'"&deptN&"' order by reimburseDate desc"
	     end if
	     if oabusyuserlevelCode="DSZ" then
	     stage1=3
	     sql="select * from reimlisttable where ((stage >3 and stage <11) or ( claimant="&"'"&oabusyusername&"')) and reimburseDate between '"&t1&"' and '"&t2&"' and dept="&"'"&deptN&"' order by reimburseDate desc"
	     end if
		 if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
	     sql="select * from reimlisttable where ((stage >3 and stage < 11) or ( dept="&"'"&oabusyuserdept&"' and stage>0)) and reimburseDate between '"&t1&"' and '"&t2&"' and dept="&"'"&deptN&"' order by reimburseDate desc"
	     end if
	     if oabusyuserlevelCode="CN" then
	     sql="select * from reimlisttable where ((stage>6 and  stage<10) or ( claimant="&"'"&oabusyusername&"')) and reimburseDate between '"&t1&"' and '"&t2&"' and dept="&"'"&deptN&"'  order by reimburseDate desc"
	     end if
	     if oabusyuserlevelCode="CW" then
	     sql="select * from reimlisttable where ((stage>4 and  stage<10) or ( claimant="&"'"&oabusyusername&"')) and reimburseDate between '"&t1&"' and '"&t2&"' and dept="&"'"&deptN&"'  order by reimburseDate desc"
	     end if				
	   ...
	   if monthN<>"所有" then
		...
		if oabusyuserlevelCode="ZSYG" then
		 ...
		 if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
	     sql="select * from reimlisttable where (((dept="&"'"&oabusyuserdept&"'"&" and type='A' and stage>0) or (dept<>"&"'"&oabusyuserdept&"'"&" and type='A' and stage>2)) or (type='B' and projectDept = "&"'"&oabusyuserdept&"'"&" and stage>0)) and reimburseDate='"&t1&"' and dept="&"'"&deptN&"' order by reimburseDate desc" 
	     end if
	     if oabusyuserlevelCode="CWZG" then
	     sql="select * from reimlisttable where ((stage >2 and stage <11) or ( claimant="&"'"&oabusyusername&"')) and reimburseDate='"&t1&"'and dept="&"'"&deptN&"'  order by reimburseDate desc"
	     end if
	     if oabusyuserlevelCode="DSZ" then
	     stage1=3
	     sql="select * from reimlisttable where ((stage >3 and stage <11) or ( claimant="&"'"&oabusyusername&"'))  and reimburseDate='"&t1&"' and dept="&"'"&deptN&"' order by reimburseDate desc"
	     end if
		 if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
	     sql="select * from reimlisttable where ((stage >3 and stage < 11) or ( dept="&"'"&oabusyuserdept&"' and stage>0)) and reimburseDate='"&t1&"' and dept="&"'"&deptN&"' order by reimburseDate desc"
	     end if
	     if oabusyuserlevelCode="CN" then
	     sql="select * from reimlisttable where ((stage>6 and  stage<10) or ( claimant="&"'"&oabusyusername&"'))  and reimburseDate='"&t1&"'  and dept="&"'"&deptN&"' order by reimburseDate desc"
	     end if
	     if oabusyuserlevelCode="CW" then
	     sql="select * from reimlisttable where ((stage>4 and  stage<10) or ( claimant="&"'"&oabusyusername&"'))  and reimburseDate='"&t1&"' and dept="&"'"&deptN&"'  order by reimburseDate desc"
	     end if		
	    'sql1="select * from reimbursementlist where ((stage>0 and stage<9) or stage=10 or (stage=0 and claimant="&"'"&oabusyname&"'))  and reimburseDate>=#"&t1&"# and reimburseDate<#"&t2&"# and dept="&"'"&deptN&"' and  finance="&"'"&oabusyname&"'"
		stra=deptN&yearN&"年"&monthN&"月"&dayN&"的申请"
