...
<tr>
<td>报销人</td><td><%=rs("claimant")%></td><td>部门</td><td><%=rs("dept")%></td><td>项目负责人</td><td><%=rs("principal")%></td>
</tr>
<tr>
...
<tr>
<td>部门审批</td><td colspan="5">&nbsp;<%=rs("deptNotes")%></td>
</tr>
<tr>
<td>财务审批</td><td colspan="5">&nbsp;<%=rs("financialNotes")%></td>
</tr>
<tr>
<td>机构负责人审批</td><td colspan="5">&nbsp;<%=rs("gManagerNotes")%></td>
</tr>
