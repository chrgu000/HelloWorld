...
<script Language="JavaScript">
 ...
 function change()
 {
               window.open('Change.asp?username='+ document.form2.username.value+"&password="+document.form2.password.value+"&repassword="+document.form2.repassword.value+"&name="+document.form2.name.value+"&dept="+document.form2.dept.value+"&userlevel="+document.form2.userlevel.value,"_self");
 }
...
<form action="<%=#@~^BAAAAA==4M+WpQEAAA==^#~@%>" method=post name="form2" >
...
<tr>
<td align=center>
<input type="button"  value="更改" onClick="change();">&nbsp;&nbsp;<input type="button" value="返回" onClick="window.location.href='usercontrol.asp'">
</td>
</tr>
</table>
</form>
