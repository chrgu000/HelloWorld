...
<body>
<center>
<p><font size="+1" color="#dd0000">重新发送邮件</font></p>
  <table border="1" width="500" cellspacing="0" cellpadding="0" bordercolorlight="#6FECFF" bordercolordark="#FFFFFF">
    <tr>
      ...
      <font color="#336699"><%=server.htmlencode(rs("emailtitle"))%>（<%=cstr(rs("emaildate"))%>发送给<%=server.htmlencode(rs("explain"))%>）</font>	  </td>
    </tr>
  <center>
    <tr>
...
<td bgcolor="D8F7FF"> 
收 件 人：
  <input type="text" name="getuser" size="50" value="<%=server.htmlencode(rs("explain"))%>" onFocus="document.form1.title.focus();"><font color=red>*<input type="button" value="增加" name="adduser" onClick="addgetemailuser();"></font>
...
<tr>
<td bgcolor="D8F7FF">
<center>邮件内容</center><textarea rows="9" name="content" cols="60"><%=server.htmlencode(rs("emailcontent"))%></textarea></td>
</tr>
</table>
<br>
<input type="submit" name="submit" value="重新发送">&nbsp;&nbsp;<input type="button" value="关闭" onClick="window.close()">
</form>
</center>	
</body>
</html>
