...
<form name="form" action="saveCode.asp" method="post">
<tr bgcolor="#FFFFFF">
    <td><span class="style8"><font size="2"><%=rs("username")%></font></span></td>
	<td><font size="2"><input type="text" name="levelCode" value="<%=rs("levelCode")%>" /></font></td>
</tr>
<tr>
	<td colspan="2"><font size="2"><input type="hidden" name="Codeid" value="<%=rs("ID")%>" /><input type="submit" value="修改" /></font></td>
</tr>
</form>
</table>
</div>
