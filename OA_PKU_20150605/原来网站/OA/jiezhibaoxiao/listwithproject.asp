...
<%
		...
		'sql="select *  from reimlisttable where projectId='"&projectId&"'"
		   if (yearN="" and monthN="") or yearN="所有" then
		      sql="select *  from reimlisttable where projectId='"&projectId&"'  and (stage>6 and stage<10)"
			...
			if yearN<>"所有" and yearN<>"" and monthN="所有" then
			   ...
			   sql="select *  from reimlisttable where projectId='"&projectId&"' and reimburseDate>=#"&t1&"# and reimburseDate<#"&t2&"#  and (stage>6 and stage<10)"
