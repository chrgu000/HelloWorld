...
<table border=0  cellspacing="1" bgcolor="B0C8EA" width="88%">
  ...
  <tr bgcolor="D7E8F8"> 
	<td colspan="2" bgcolor="D7E8F8">凭证号</td><td colspan="6"><%=certificateNo%></td>
  </tr>
  <tr bgcolor="D7E8F8"> 
    <td colspan="8" >
...
<%
  ...
  if flag=1 then
   %>
  <tr height="18" bgcolor="D7E8F8">
    <td>您的审批意见</td>
    <td colspan="13" bgcolor="D7E8F8"><textarea cols="150" rows="4" name="note"></textarea></td>
  </tr>
  <%end if%>
  </font>
</table>
