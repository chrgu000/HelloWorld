...
<table  border=0  cellspacing="1" bgcolor="B0C8EA" cellpadding="0"  width="95%" >
  <tr bgcolor="D7E8F8"> 
	...
	set rs=server.createobject("adodb.recordset")
	sql="select projectId, projectName from projectType order by projectId"
	rs.open sql,conn,1,1
	if not rs.eof and not rs.bof then
	do while not rs.eof and not rs.bof 
	%>
 ...
 <tr bgcolor="D7E8F8"> 
  ...
  <tr bgcolor="D7E8F8"> 
    <td colspan="8" >
		<TABLE id="table" border=0  cellspacing="1"  cellpadding="0"  width="100%" bgcolor="B0C8EA" >
  <tr bgcolor="D7E8F8"> 
			<td>科目</td>
    		<td>详细科目</td>
    		<td>金额</td>
	  ...
	  <TABLE id="table1" border=1  cellspacing="1"   cellpadding="0" width="100%" bgcolor="B0C8EA" >
 <tr bgcolor="D7E8F8"> 
 	<td colspan="8" bgcolor="D7E8F8"><span id="t" name="t"></span></td>
	</tr>
</TABLE> 
	</td>
  </tr>
