...
<table border=0  cellspacing="1" bgcolor="B0C8EA" width="90%" >
  <tr bgcolor="D7E8F8"> 
    ...
    <td>项目周期</td><td><input type="text"  name="pcycle" /></td>   
 </tr>
 <tr bgcolor="D7E8F8"> 
  ...
  <tr bgcolor="D7E8F8"> 
    <td colspan="8" >
		<TABLE id="table" border=0  cellspacing="1" bgcolor="B0C8EA" width="100%" >
  <tr bgcolor="D7E8F8"> 
			<td>科目</td>
    		<td>详细科目</td>
    		<td>金额</td>
	  ...
	  <TABLE id="table1" border=1  cellspacing="1" bgcolor="B0C8EA" width="100%" >
 <tr bgcolor="D7E8F8"> 
