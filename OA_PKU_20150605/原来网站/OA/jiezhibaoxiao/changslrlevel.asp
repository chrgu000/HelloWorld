...
sql="select * from userinf where forbid='no'  order by slrlevel"
...
<tr bgcolor="D7E8F8"> 
    ...
    <td><span class="style8"><font size="2">调整薪资级别</font></span></td>
 </tr>
<% do while not rs.eof %>
<tr bgcolor="D7E8F8"> 
	<td><span class="style8"><font size="2"><%=rs("username")%></font></span></td>
    <td><font size="2"><%=rs("slrlevel")%></font></td>
    <td><font size="2"><a href="changslrcode.asp?id=<%=rs("id")%>"><%=rs("id")%></a></font></td>
</tr>
<%
rs.movenext
loop%>
