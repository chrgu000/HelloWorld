...
<option vlue="所有部门"  <%=selected("所有部门",deptN)%>>所有部门</option>
	<%
	  ...
	  sql="select distinct(borrowerdeptcode) from borrowlist"
	  rs.open sql,conn,1,1
	  do while not rs.eof 
	%>
	<option value="<%=rs("borrowerdeptcode")%>"  <%=selected(rs("borrowerdeptcode"),deptN)%>><%=getdept(rs("borrowerdeptcode"))%></option>
	<% 
	rs.movenext
	loop
	%>
...
'getsql dept1,year1,month1 
  if deptN="所有部门" then 
     if yearN="所有" then
		...
		stage1=1
		sql1="select * from borrowlist where (borrowerdeptcode="&"'"&getdeptcode(oabusyuserdept)&"'"&" and stage > 0)  or ( borrower="&"'"&oabusyusername&"')" 
		end if
		if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
		stage1=1
		...
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
		stage1=3
		sql1="select * from borrowlist where (stage > 3 and stage < 10) or (borrowerdeptcode="&"'"&getdeptcode(oabusyuserdept)&"'"&" and stage > 0)  or ( borrower="&"'"&oabusyusername&"') "
		end if
	 ...
	 if yearN<>"所有" then
	   if monthN="" then
		...
		stage1=0
		sql1="select * from borrowlist where borrower="&"'"&oabusyusername&"' and asktime between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="BMJL" and oabusyuserdept<>"综合管理部" then
		stage1=1
		sql1="select * from borrowlist where ((borrowerdeptcode="&"'"&getdeptcode(oabusyuserdept)&"'"&" and stage > 0)  or (borrower="&"'"&oabusyusername&"')) and asktime between '"&t1&"' and '"&t2&"'" 
		end if
		if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
		stage1=1
		sql1="select * from borrowlist where  (stage > 2 or ( borrower="&"'"&oabusyusername&"')) and asktime between '"&t1&"' and '"&t2&"'" 
		end if
		if oabusyuserlevelCode="CWZG" then
		stage1=3
		sql1="select * from borrowlist where ((stage >2 and stage < 10) or ( borrower="&"'"&oabusyusername&"')) and asktime between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1<>"BMJL" then
		stage1=3
		sql1="select * from borrowlist where (stage > 3 and stage < 10) and asktime between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
		stage1=3
		sql1="select * from borrowlist where ((stage > 3 and stage < 10) or (borrowerdeptcode="&"'"&getdeptcode(oabusyuserdept)&"'"&" and stage > 0)  or ( borrower="&"'"&oabusyusername&"')) and asktime between '"&t1&"' and '"&t2&"' "
		end if
		if oabusyuserlevelCode="CN" then
		stage1=3
		sql1="select * from borrowlist where ((stage>6 and  stage<10) or ( borrower="&"'"&oabusyusername&"')) and asktime between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="CW" then
		stage1=3
		sql1="select * from borrowlist where ((stage>6 and  stage<10) or ( borrower="&"'"&oabusyusername&"')) and asktime between '"&t1&"' and '"&t2&"'"
	   ...
	   if monthN<>"" then
		...
		if oabusyuserlevelCode="BMJL" and oabusyuserdept<>"综合管理部" then
		stage1=1
		sql1="select * from borrowlist where ((dept="&"'"&oabusyuserdept&"'"&" and stage > 0)  or ( borrower="&"'"&oabusyusername&"')) and asktime between '"&t1&"' and '"&t2&"'" 
		end if
		if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
		stage1=1
		sql1="select * from borrowlist where  (stage > 2 or ( borrower="&"'"&oabusyusername&"')) and asktime between '"&t1&"' and '"&t2&"'" 
	    ...
	    'sql1="select * from borrowlist where stage>1 and stage<8 and date>=#"&t1&"# and date<#"&t2&"# and finance="&"'"& oabusyusername&"'"
		stra=getdept(deptN)&yearN&"年"&monthN&"月"&"的申请"
	   end if
	 end if
  end if
  ...
  if deptN<>"所有部门"  and deptN<>"" then 
     if yearN="所有" then
		...
		if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
		stage1=1
		sql1="select * from borrowlist where  (stage > 2 or ( borrower="&"'"&oabusyusername&"')) and borrowerdeptcode="&"'"&deptN&"'" 
		end if
		if oabusyuserlevelCode="CWZG" then
		stage1=3
		sql1="select * from borrowlist where ((stage >2 and stage < 10) or ( borrower="&"'"&oabusyusername&"')) and borrowerdeptcode="&"'"&deptN&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1<>"BMJL" then
		stage1=3
		sql1="select * from borrowlist where (stage > 3 and stage < 10) and  borrowerdeptcode="&"'"&deptN&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
		stage1=3
		sql1="select * from borrowlist where ((stage > 3 and stage < 10) or (borrowerdeptcode="&"'"&oabusyuserdept&"'"&" and stage > 0)  or ( borrower="&"'"&oabusyusername&"')) and  borrowerdeptcode="&"'"&deptN&"'"
		end if
		if oabusyuserlevelCode="CN" then
		stage1=3
		sql1="select * from borrowlist where ((stage>6 and  stage<10) or ( borrower="&"'"&oabusyusername&"')) and borrowerdeptcode="&"'"&deptN&"'"
		end if
		if oabusyuserlevelCode="CW" then
		stage1=3
		sql1="select * from borrowlist where ((stage>6 and  stage<10) or ( borrower="&"'"&oabusyusername&"')) and borrowerdeptcode="&"'"&deptN&"'"
	 ...
	 if yearN<>"所有" and yearN<>"" then
	   if monthN="" then
		...
		if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
		stage1=1
		sql1="select * from borrowlist where  (stage > 2 or ( borrower="&"'"&oabusyusername&"')) and borrowerdeptcode="&"'"&deptN&"' and asktime between '"&t1&"' and '"&t2&"'" 
		end if
		if oabusyuserlevelCode="CWZG" then
		stage1=3
		sql1="select * from borrowlist where ((stage >2 and stage < 10) or ( borrower="&"'"&oabusyusername&"')) and borrowerdeptcode="&"'"&deptN&"' and asktime between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1<>"BMJL" then
		stage1=3
		sql1="select * from borrowlist where (stage > 3 and stage < 10) and  borrowerdeptcode="&"'"&deptN&"'and asktime between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
		stage1=3
		sql1="select * from borrowlist where ((stage > 3 and stage < 10) or (borrowerdeptcode="&"'"&getdeptcode(oabusyuserdept)&"'"&" and stage > 0)  or ( borrower="&"'"&oabusyusername&"')) and  borrowerdeptcode="&"'"&deptN&"'and asktime between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="CN" then
		stage1=3
		sql1="select * from borrowlist where ((stage>6 and  stage<10) or ( borrower="&"'"&oabusyusername&"')) and borrowerdeptcode="&"'"&deptN&"' and asktime between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="CW" then
		stage1=3
		sql1="select * from borrowlist where ((stage>6 and  stage<10) or ( borrower="&"'"&oabusyusername&"')) and borrowerdeptcode="&"'"&deptN&"' and asktime between '"&t1&"' and '"&t2&"'"
...
do while not rsborr.eof  
 %>
  ...
  <td align=center><%=getdept(rsborr("borrowerdeptcode"))%></td>
  <% 
	

	set conn=opendb("lmtof","conn","sql")
    set rs=server.CreateObject("adodb.recordset")
    sql="select * from userinf where userdept="&"'"&getdept(rsborr("borrowerdeptcode"))&"'"&"and (levelCode='BMJL' or levelCode1='BMJL' or levelCode='DSZ')"
    rs.open sql,conn,1,1
%>
	<td align=center>
	<%
    ...
    %>
	<td align=center>
    <% if getstagetf("0;10;15",rsborr("stage"))=1 then%>
	<%=rs2("txt")%>
    <%else%>
    <%=rs2("txt")&"【<font color=red>"&rsborr("nowverify")&"</font>】"%>
    <%end if%>
    </td>
	<td align=center>
