...
<form name="form" action="saveslrCode.asp" method="post">
<tr bgcolor="D7E8F8"> 
	<td><span class="style8"><font size="2"><%=rs("username")%></font></span></td>
	<td><input type="text" name="slrlevel" value="<%=rs("slrlevel")%>" /></td>
</tr>
<tr>
<td colspan="2"><input type="hidden" name="Codeid" value="<%=rs("ID")%>" /><input type="submit" value="修改" /></td>
</tr>
</form>
</table>
</div>
