...
'sql1="select * from borrowlist_old where stage > 1 and  stage < 6 "
'getsql dept1,year1,month1 
  if deptN="所有部门" then 
     if yearN="所有" then
		...
		stage1=0
		sql1="select * from borrowlist_old where borrower="&"'"&oabusyusername&"'"
		end if
		if oabusyuserlevelCode="BMJL" and oabusyuserdept<>"综合管理部" then
		stage1=1
		sql1="select * from borrowlist_old where (dept="&"'"&oabusyuserdept&"'"&" and stage > 0)  or ( borrower="&"'"&oabusyusername&"')" 
		end if
		if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
		stage1=1
		sql1="select * from borrowlist_old where  (stage > 2 or ( borrower="&"'"&oabusyusername&"'))" 
		end if
		if oabusyuserlevelCode="CWZG" then
		stage1=3
		sql1="select * from borrowlist_old where (stage >2 and stage < 10)  or ( borrower="&"'"&oabusyusername&"')"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1<>"BMJL" then
		stage1=3
		sql1="select * from borrowlist_old where stage > 3 and stage < 10"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
		stage1=3
		sql1="select * from borrowlist_old where (stage > 3 and stage < 10) or (dept="&"'"&oabusyuserdept&"'"&" and stage > 0)  or ( borrower="&"'"&oabusyusername&"') "
		end if
		
		if oabusyuserlevelCode="CN" then
		stage1=3
		sql1="select * from borrowlist_old where (stage>6 and  stage<10)  or ( borrower="&"'"&oabusyusername&"')"
		end if
	   ...
	   'sql1="select * from borrowlist_old where stage>1 and stage<8 and finance="&"'"&oabusyusername&"'"
	   stra="所有的申请"
	 end if
	 if yearN<>"所有" then
	   if monthN="" then
		...
		stage1=0
		sql1="select * from borrowlist_old where borrower="&"'"&oabusyusername&"' and date between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="BMJL" and oabusyuserdept<>"综合管理部" then
		stage1=1
		sql1="select * from borrowlist_old where ((dept="&"'"&oabusyuserdept&"'"&" and stage > 0)  or (borrower="&"'"&oabusyusername&"')) and date between '"&t1&"' and '"&t2&"'" 
		end if
		if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
		stage1=1
		sql1="select * from borrowlist_old where  (stage > 2 or ( borrower="&"'"&oabusyusername&"')) and date between '"&t1&"' and '"&t2&"'" 
		end if
		if oabusyuserlevelCode="CWZG" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage >2 and stage < 10) or ( borrower="&"'"&oabusyusername&"')) and date between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1<>"BMJL" then
		stage1=3
		sql1="select * from borrowlist_old where (stage > 3 and stage < 10) nd date between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage > 3 and stage < 10) or (dept="&"'"&oabusyuserdept&"'"&" and stage > 0)  or ( borrower="&"'"&oabusyusername&"')) and date between '"&t1&"' and '"&t2&"' "
		end if
		if oabusyuserlevelCode="CN" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage>6 and  stage<10) or ( borrower="&"'"&oabusyusername&"')) and date between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="CW" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage>6 and  stage<10) or ( borrower="&"'"&oabusyusername&"')) and date between '"&t1&"' and '"&t2&"'"
	    ...
	    'sql1="select * from borrowlist_old where stage>1 and stage<8 and date>=#"&t1&"# and date<#"&t2&"# and finance="&"'"& oabusyusername&"'  "
	   ...
	   if monthN<>"" then
		...
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1<>"BMJL" then
		stage1=3
		sql1="select * from borrowlist_old where (stage > 3 and stage < 10) and date between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage > 3 and stage < 10) or (dept="&"'"&oabusyuserdept&"'"&" and stage > 0)  or ( borrower="&"'"&oabusyusername&"')) and date between '"&t1&"' and '"&t2&"'"
  ...
  if deptN<>"所有部门"  and deptN<>"" then 
     if yearN="所有" then
		...
		if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
		stage1=1
		sql1="select * from borrowlist_old where  (stage > 2 or ( borrower="&"'"&oabusyusername&"')) and dept="&"'"&deptN&"'" 
		end if
		if oabusyuserlevelCode="CWZG" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage >2 and stage < 10) or ( borrower="&"'"&oabusyusername&"')) and dept="&"'"&deptN&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1<>"BMJL" then
		stage1=3
		sql1="select * from borrowlist_old where (stage > 3 and stage < 10) and  dept="&"'"&deptN&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage > 3 and stage < 10) or (dept="&"'"&oabusyuserdept&"'"&" and stage > 0)  or ( borrower="&"'"&oabusyusername&"')) and  dept="&"'"&deptN&"'"
		end if
		if oabusyuserlevelCode="CN" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage>6 and  stage<10) or ( borrower="&"'"&oabusyusername&"')) and dept="&"'"&deptN&"'"
		end if
		if oabusyuserlevelCode="CW" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage>6 and  stage<10) or ( borrower="&"'"&oabusyusername&"')) and dept="&"'"&deptN&"'"
	   ...
	   'sql1="select * from borrowlist_old where stage>1 and stage<8 and dept="&"'"&deptN&"' and finance="&"'"&oabusyusername&"'"
	   stra=deptN&yearN&"年的申请"
	 end if
	 if yearN<>"所有" and yearN<>"" then
	   if monthN="" then
		...
		if oabusyuserlevelCode="BMJL" and oabusyuserdept="综合管理部" then
		stage1=1
		sql1="select * from borrowlist_old where  (stage > 2 or ( borrower="&"'"&oabusyusername&"')) and dept="&"'"&deptN&"' and date between '"&t1&"' and '"&t2&"'" 
		end if
		if oabusyuserlevelCode="CWZG" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage >2 and stage < 10) or ( borrower="&"'"&oabusyusername&"')) and dept="&"'"&deptN&"' and date between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1<>"BMJL" then
		stage1=3
		sql1="select * from borrowlist_old where (stage > 3 and stage < 10) and  dept="&"'"&deptN&"'and date between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="DSZ" and oabusyuserlevelCode1="BMJL" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage > 3 and stage < 10) or (dept="&"'"&oabusyuserdept&"'"&" and stage > 0)  or ( borrower="&"'"&oabusyusername&"')) and  dept="&"'"&deptN&"'and date between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="CN" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage>6 and  stage<10) or ( borrower="&"'"&oabusyusername&"')) and dept="&"'"&deptN&"' and date between '"&t1&"' and '"&t2&"'"
		end if
		if oabusyuserlevelCode="CW" then
		stage1=3
		sql1="select * from borrowlist_old where ((stage>6 and  stage<10) or ( borrower="&"'"&oabusyusername&"')) and dept="&"'"&deptN&"' and date between '"&t1&"' and '"&t2&"'"
	    ...
	    'sql1="select * from borrowlist_old where stage>1 and stage<8 and date>=#"&t1&"# and date<#"&t2&"# and dept="&"'"&deptN&"' and finance="&"'"&oabusyusername&"'"
		stra=deptN&yearN&"年的申请"
	   end if
	   if monthN<>"" then
	    t1=DateSerial(yearN,monthN,1)
