...
stage1=0
'sql= "select * from borrowlist_old where id= "&ID&" and (stage=0 or stage=6)" 
sql= "select * from borrowlist_old where id= "&ID
end if
if oabusyuserlevelCode="BMJL" then 
stage1=1
'sql= "select * from borrowlist_old where id= "&ID&" and (stage="&stage1&" or stage=0 or (stage=6 and borrower = "&"'"&oabusyusername&"'"&"))" 
sql= "select * from borrowlist_old where id= "&ID
end if
if oabusyuserlevelCode="CWZG" then 
stage1=2
'sql= "select * from borrowlist_old where  id= "&ID&" and (stage="&stage1&"  or stage=4  or ((stage=6 or stage=0 )and borrower = "&"'"&oabusyusername&"'"&"))" 
sql= "select * from borrowlist_old where id= "&ID
end if
if oabusyuserlevelCode="DSZ" then 
stage1=3
'sql= "select * from borrowlist_old where id= "&ID&" and (stage="&stage1&" or stage=0 or stage=6)" 
sql= "select * from borrowlist_old where id= "&ID
end if
