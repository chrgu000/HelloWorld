...
if oabusyuserlevelCode="BMJL" then
   sqlstr="select * from borrowlist_old where dept = "& "'" & oabusyuserdept & "'" & "and stage =1"
end if
if oabusyuserlevelCode="CW" then
   sqlstr="select * from  borrowlist_old where stage=2 or stage=4 or (stage=1 and borrower= "& "'" & oabusyname & "'" &")"
end if
if oabusyuserlevelCode="DSZ" then
   sqlstr="select * from  borrowlist_old where  stage=3"
end if
if oabusyuserlevelCode="CWZG" then
   sqlstr="select * from  borrowlist_old where  stage=10"
end if
