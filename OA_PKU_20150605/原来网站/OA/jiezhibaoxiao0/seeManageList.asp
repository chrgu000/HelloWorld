...
if oabusyuserlevelCode="bmjl" then
     if yearN="所有" then
	   if monthN="" then
	   sql1="select * from borrowlist_old where stage>1 and stage<6 and dept="&"'"&oabusyuserdept&"'"
	   end if
	   if monthN<>"" then
	   sql1="select * from borrowlist_old where stage>1 and stage<6 and dept="&"'"&oabusyuserdept&"'"
	   end if
	 ...
	 if yearN<>"所有" and yearN<>"" then
	    ...
	    sql1="select * from borrowlist_old where stage>1 and stage<6 and date>=#"&t1&"# and date<#"&t2&"#"&" and dept="&"'"&oabusyuserdept&"'"
...
'sql1="select * from borrowlist_old where stage=2 and dept="&"'"&oabusyuserdept&"'"
...
if oabusyuserlevelCode="DSZ" or oabusyuserlevelCode="CN" or oabusyuserlevelCode="CW" then
     if yearN="所有" then
	   if monthN="" then
	   sql1="select * from borrowlist_old where stage>3 and stage<9  "
	   end if
	   if monthN<>"" then
	   sql1="select * from borrowlist_old where stage>3 and stage<9  "
	   end if
	 ...
	 if yearN<>"所有" and yearN<>"" then
	    ...
	    t1=DateSerial(yearN,1,1)
		t2=DateSerial(yearN+1,1,1)
	    sql1="select * from borrowlist_old where stage>3 and stage<9 and date>=#"&t1&"# and date<#"&t2&"#  "
		response.Write(yearN&"年的申请")
	   end if
	   if monthN<>"" then
	    t1=DateSerial(yearN,monthN,1)
