...
function opendby(DBPath,sessionname,dbsort)
dim conn
...
if request("submit")="确定" then
	...
	For i=0 To 4
    'Response.Write(FormatDateTime(amcometime,i) & "<br />")
    Next
	...
	sql="update inittime set amondutytime=#"&FormatDateTime(amcometime,4)&"#,amoffdutytime=#"&FormatDateTime(amgotime,4)&"#,pmondutytime=#"&FormatDateTime(pmcometime,4)&"#,pmoffdutytime=#"&FormatDateTime(pmgotime,4)&"#,ondutydelaytime="&comedelaytime&",offdutyaheadtime="&goaheadtime&",kqtimephase="&kqtimephase&",amgonokq="&amgonokq&",pmcomenokq="&pmcomenokq&",pmgonokq="&pmgonokq
	'response.Write(sql)
	conn.execute(sql)
