...
allow_edit_all_wageinf=request("allow_edit_all_wageinf")
if allow_edit_all_wageinf="" then allow_edit_all_wageinf="no"

allow_edit_dept_wageinf=request("allow_edit_dept_wageinf")
if allow_edit_dept_wageinf="" then allow_edit_dept_wageinf="no"

set conn=opendb("oabusy","conn","accessdsn")
sql="update userinf set "
sql=sql & "allow_edit_dept_wageinf=" & sqlstr(allow_edit_dept_wageinf) & ","
sql=sql & "allow_edit_all_wageinf=" & sqlstr(allow_edit_all_wageinf) & " where id=" & request("id")
conn.Execute sql
...
rs.open sql,conn,1
%>
<form method="post" action="wageinfpopedom.asp">
<td>
...
<td align=center>可编辑所有员工工资档案</td>
<td align=center>可编辑本部门员工工资档案</td>
<td>&nbsp;</td>
</tr>
<%
'显示用户表
...
<td align=center><input type="checkbox" name="allow_edit_all_wageinf" value="yes"<%=checked(rs("allow_edit_all_wageinf"),"yes")%>></td>
<td align=center><input type="checkbox" name="allow_edit_dept_wageinf" value="yes"<%=checked(rs("allow_edit_dept_wageinf"),"yes")%>></td>
